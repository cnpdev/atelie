...
/**
 * @ORM\Entity(repositoryClass="App\Repository\UserContributionRepository")
 * @ORM\Table(name="user_contribution",
 *	uniqueConstraints={@ORM\UniqueConstraint(name="entry_user_uniq", columns={"entry_id", "user_id"})},
 *	indexes={
 *		@ORM\Index(name="user_idx", columns={"user_id"})}
 * )
 */
class UserContribution extends Entity implements \JsonSerializable {

	/**
	 * @var Entry
	 * @ORM\ManyToOne(targetEntity="Entry", inversedBy="contribs")
	 */
	private $entry;
