 ...
 * )
 */
class Entry extends Entity implements /*RoutedItemInterface, */\JsonSerializable {
	 ...
	 * @ORM\OneToMany(targetEntity="UserContribution", mappedBy="entry")
	 */
	private $contribs;
...
//	 */
	...
	public function canShowFilesTo(User $user) {
		return $this->isAvailable() || $this->belongsTo($user) || $user->is([User::ROLE_MEMBER, User::ROLE_SUPERVISOR, User::ROLE_ADMIN]);
	}
	...
	public function hasParticipant(User $user = null) {
